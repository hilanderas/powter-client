...
```bash
wget https://github.com/hilanderas/powter-client/releases/download/0.8.1/powter-client-testflow-0.8.1.zip
unzip powter-client-testflow-0.8.1.zip
```
...
```bash
md5sum -c powter-client-testflow-0.8.1.md5
```
